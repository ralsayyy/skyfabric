...
public class CrystalHollowsMap {
    ...
    public static void register() {
        HudRenderCallback.EVENT.register(((matrixStack, tickDelta) -> {
            ...
            if (client != null && client.player != null && client.options != null && !client.options.debugEnabled && SbChecks.isCrystalHollows && AutoConfig.getConfigHolder(ModConfig.class).getConfig().dungeonConfigDropdown.dungeonMapConfigDropdown.Enabled) {
                matrixStack.push();
